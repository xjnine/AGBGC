    ...
    try:
        ...
        for i in range(features.shape[1]):
            ...
            fea, wave, hat, norm, weight = load_single_view_data(features[0][i], dataset_name, normalization, i,
                                                                 load_saved,labels,k, prunning_one,
...
def load_single_view_data(feature, dataset_name, normalization, view_no, load_saved,labels,k,
    ...
    if load_saved is not True:
        ...
        adj, adj_wave, adj_hat, _, _, _,_,_ = load_data_WGBC_v2(feature,labels,k,prunning_one,prunning_two, common_neighbors)
