...
def load_data_clusterft(adj_new, direction_path, dataset_name, load_saved=False):
    ...
    try:
        ...
        for i in range(features.shape[1]):
            ...
            fea, wave, hat, norm, weight = load_single_view_data(features[0][i], dataset_name, i,
...
def load_single_view_data(feature, dataset_name, view_no, load_saved,labels,k,
                          prunning_one, prunning_two, common_neighbors, adj_new):
    if isinstance(feature, h5py.Dataset):
        feature = feature[...]
